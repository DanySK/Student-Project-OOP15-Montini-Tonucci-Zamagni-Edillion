...
public enum ItemDurable implements Durable  {
    ...
    ANUBI( "Anubi's Helmet",               500,     500, StatType.MANA, EquipType.HELMET),
    ...
    DRAKE(     "Drake's Armor",           5000,    1000, StatType.HP,  EquipType.ARMOR),
    LIGHTNING("Lightning Greaves",        1300,      20, StatType.SPEED, EquipType.GREAVES);
